...
export default function BirthDatePage() {
  ...
  // ISSUE-080 AC1: fire ``onboarding_step`` once per visit (step 1 of 4).
  useEffect(() => {
  ...
  const errorCode: BirthDateError | null = value === '' ? null : validateBirthDate(value, today);
  ...
  return (
    <OnboardingChrome step={1}>
      <div className="flex flex-col gap-s2">
        ...
        <p className="font-body text-base text-cream-300">먼저, 너 언제 태어났어?</p>
      </div>
